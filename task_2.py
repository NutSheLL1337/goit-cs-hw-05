...
def visualize_top_words(result, top_n=10):
    """
    Створення горизонтальної гістограми для візуалізації топ-N слів за їх частотами.
    """
    # Розділення даних на слова та їх частоти
    top_words = sorted(result.items(), key=lambda x: x[1], reverse=True)[:top_n]
...
if __name__ == "__main__":
    ...
    if text:
        ...
        # Отримання тексту (функція get_text повинна бути визначена в іншій частині коду)
